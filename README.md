# Mango-Finance HTML5 + JavaScript Management Financing for budget
...
## Getting Started
In order to run **Mango-Finance** on your local machine all what you need to do is to have the prerequisites stated below installed on your machine and follow the installation steps down below.
...
```
> git clone https://github.com/alexandrumargan/mango-frontend.git mangoFrontend
> cd mangoFrontend
> npm install
> npm start
```
